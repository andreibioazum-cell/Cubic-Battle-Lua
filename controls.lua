...
local joy = { id=nil, cx=0, cy=0, sx=0, sy=0, R=60, sR=26 }
local atk = { x=0, y=0, r=70, pressed=false, id=nil, ax=0, ay=-1, aimLen=200 }
...
function c.update(dt, playerDirX, playerDirY)
    if atk.pressed then atk.ax, atk.ay = playerDirX, playerDirY end
